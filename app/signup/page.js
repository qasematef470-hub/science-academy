                ...
                <div className="p-8 md:p-12 lg:p-16 max-w-2xl mx-auto w-full">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                        ...
                        <div className={`pt-4 border-t space-y-4 ${isDark ? 'border-white/5' : 'border-gray-200'}`}>
                            ...
                            <button type="submit" disabled={googleLoading} className={`w-full font-black py-4 rounded-xl shadow-lg transition-all hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-3 ${isDark ? 'bg-white text-gray-900 border-white' : 'bg-white text-gray-900 border border-gray-300'}`}>
                                {googleLoading ? 'جاري الاتصال...' : (
                                    <>
                                        ...
                                        <span>إتمام التسجيل بحساب جوجل (Google)</span>
                                    </>
                                )}
                            </button>
                        </div>
