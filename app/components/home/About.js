                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        <p className={`text-lg leading-loose mb-6 ${theme.textSec}`}>
                            إحنا تيم من المعيدين والدكاترة، هدفنا نسهل عليك مواد الكلية ونحولها من مواد معقدة لمحتوى شيق ومفهوم. بنوفرلك كل الأدوات اللي تحتاجها للنجاح من شرح مبسط، ومراجعات نهائية، وبنك أسئلة.
                        </p>
