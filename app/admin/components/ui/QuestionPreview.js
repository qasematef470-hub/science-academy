...
export default function QuestionPreview({ question, options, image, difficulty, explanation }) {
    ...
    <div className="w-full bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-800 overflow-hidden relative">
      ...
      <div className="p-6 md:p-8">
        ...
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          {/* 4. التفسير/التلميح (لو موجود) */}
          {explanation && (
            <div className="w-full mt-6 p-5 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-right animate-fade-in shadow-inner">
              <h4 className="flex items-center gap-2 font-bold text-amber-600 dark:text-amber-500 mb-2">
                <span className="text-xl">💡</span>
                <span>تفسير الحل:</span>
              </h4>
              <div className="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed pl-6">
